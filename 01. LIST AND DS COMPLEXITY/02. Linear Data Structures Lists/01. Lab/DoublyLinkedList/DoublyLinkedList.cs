...
{
    //When one class is entirely dependent upon another, you may decide to implement it using a nested class.
    ...
    //Instance of Inner class can access non-static member declared in Outer class
